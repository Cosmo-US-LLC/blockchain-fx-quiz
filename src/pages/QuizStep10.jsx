...
const QuizStep10 = () => {
  ...
  return (
    <div className="quiz-container min-h-screen  max-h-[100vh] flex flex-col items-center px-4">
      ...
      <div className="max-w-[750px] w-full text-center mt-6">
        ...
        <div className="grid grid-cols-1 max-w-[560px] mx-auto md:grid-cols-1 gap-2 mt-6">
          {options.map((option) => (
            <div
              key={option.title}
              style={{
